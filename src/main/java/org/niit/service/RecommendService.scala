...
//      val path = value(0)
      val path = "D:\\Administrator\\Documents\\Gary\\作业\\大数据\\BD2\\大数据分析课程实践项目\\Restaurant_recommendation\\output\\als_model\\1683558939609"
      //2.加载模型
      ...
      allInfoDF.write
        ...
        .option("dbtable", "takeaway") //写到takeaway表里面
